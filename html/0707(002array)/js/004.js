...
//     document.writeln("<hr>");
//     for(let i = 0; i < scores.length; i ++){
//         document.writeln(`${arrays[i]} 총점 : ${sumScore(scores)[i]}점<br>`);
//         document.writeln(`${arrays[i]} 평균 : ${avgScore(scores)[i]}점<br><hr>`);
//     }
// }
...
// 과목별 총점, 평균 출력
// printClassScore(scores, classes);
// 과목별 자료를 치환해서 학생별 총점, 평균 출력
// printStudentScore(scores, names);
